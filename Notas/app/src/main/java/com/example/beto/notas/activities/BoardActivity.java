...
import com.example.beto.notas.adapters.BoardAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showAlertForCreatingBoard("Agregar nuevo tablero", "Ingresa un nombre para tu tablero");
            }
        });
        ...
        builder.setPositiveButton("Agregar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (boardName.length() > 0)
                    ...
                    Toast.makeText(getApplicationContext(), "El nombre del tablero es requerido", Toast.LENGTH_LONG).show();
    ...
    private void showAlertForEditingBoard(String title, String message, final Board board) {
        ...
        builder.setPositiveButton("Guardar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (boardName.length() == 0)
                    Toast.makeText(getApplicationContext(), "EL NOMBRE NO DEBE ESTAR VACÍO", Toast.LENGTH_LONG).show();
                 else if (boardName.equals(board.getTitle()))
                    Toast.makeText(getApplicationContext(), "EL NOMBRE ES EL MISMO QUE EL ANTERIOR", Toast.LENGTH_LONG).show();
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.edit_board:
                showAlertForEditingBoard("Editar tablero", "Cambiar el nombre del tablero", boards.get(info.position));
                return true;
